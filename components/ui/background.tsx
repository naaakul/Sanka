...
const background = () => {
  return (
    <div className="absolute -inset-y-[25%] -right-24 md:-right-6 w-[100vw] md:w-[1200px] flex flex-col blur-md [mask-image:linear-gradient(to_right,rgba(255,255,255,0),white)]">
