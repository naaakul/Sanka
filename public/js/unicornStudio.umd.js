(function (_, D) {
  ...
  var rs = (_, D, g) =>
    D in _
      ? is(_, D, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (_[D] = g);
  ...
  class it {
    constructor({
      ...
      if (
        ((this.gl = this.canvas.getContext("webgl2", S)),
...
`,
    ...
    createUniforms(e) {
      ((this.uniformsManager = new nt(this.renderer, this.program, e)),
        this.setUniforms());
    }
    setUniforms() {
  ...
  class Z {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = B),
        (r[11] = 0),
        (r[12] = e.x + Y - (q * Y + R * U + $ * V)),
        (r[13] = e.y + U - (P * Y + x * U + ie * V)),
        (r[14] = e.z + V - (w * Y + z * U + B * V)),
        (r[15] = 1),
        this
      );
    }
...
gl.LINEAR filtering will be used instead`
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? Ee.set(this._parent.scale.x, this._parent.scale.y)
          : Ee.set(1, 1),
...
`,
  ...
  class He extends _t {
    constructor(
      ...
      t,
      {
        ...
        visible: v = !0,
        transparent: T = !1,
        drawCheckMargins: S = { top: 0, right: 0, bottom: 0, left: 0 },
        autoloadSources: E = !0,
        watchScroll: M = !0,
        fov: k = 50,
        customScale: C = 1,
          ...
          : s[0] === 1
            ...
            : s[0] === 2
              ? ((t[2] = this._getIntersection(
                ...
                t.push(
                  this._getIntersection(t[1], H.set(1, 0.95, 0).applyMat4(i))
                ))
              : s[0] === 3 &&
    ...
    mouseToPlaneCoords(e) {
      if (
        ...
        Ne.equals(this.quaternion) && St.equals(this.transformOrigin))
      )
  ...
  typeof document.hidden < "u"
    ? ((ye = "hidden"), (de = "visibilitychange"))
    : typeof document.msHidden < "u"
      ? ((ye = "msHidden"), (de = "msvisibilitychange"))
      : typeof document.webkitHidden < "u" &&
        ((ye = "webkitHidden"), (de = "webkitvisibilitychange"));
  function zt(n, e) {
    let t;
    return function (...s) {
      (clearTimeout(t),
  ...
  function ze(n, e, t) {
    if (be) {
      n.loadImage(be, { sampler: "uTexture" });
      return;
    }
  ...
  class Ut {
    ...
    updateEffect(e, t) {
      ...
      if (this.loop !== "none") {
        ...
        let c = d;
        return (
          this.loop === "reverse" && u % 2 === 1 && (c = 1 - d),
          (this.progress = i(c)),
          (this.lastTick = s),
          ge(this.value, e, this.progress)
        );
      }
      ...
      return (
        ...
        this.progress === 0
          ...
          : (h >= 1 && ((this.complete = !0), (this.progress = 0)),
            (this.lastTick = s),
            this.complete ? !1 : ge(this.value, e, this.progress))
      );
    }
    resetState() {
      ((this.progress = 0),
  ...
  class Vt {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= G), this.mode === "scrollIntoView")) {
        ...
        return (
          this.lastTick !== void 0 &&
            (o = Pe(o, this.lastTick, this.momentum * 2)),
          this.lastTick !== void 0 && Math.abs(this.lastTick - o) < 1e-4
            ? !1
            : ((this.lastTick = o), ge(e, this.value, o))
        );
        ...
        return (
          ...
          this.lastTick !== void 0 &&
          ((r = Pe(r, this.lastTick, this.momentum * 2)), Math.abs(r) < 0.001)
            ? !1
      ...
      return (
        ...
        !t && !u
          ...
          : (!t &&
            ...
            (this.lastTick = r),
            (this.lastEnterTime = t),
            u ? ge(e, this.value, this.progress) : !1)
      );
    }
    resetState() {
      this.progress = 0;
        ...
        (this.states = {
          appear:
            e.states && e.states.appear
              ? e.states.appear.map((s) => new Ut(s))
              : [],
          scroll:
            e.states && e.states.scroll
              ? e.states.scroll.map((s) => new Vt(s))
              : [],
          hover:
            e.states && e.states.hover
              ? e.states.hover.map((s) => new Bt(s))
              : [],
        }));
    }
    state() {
          ...
          (this.getPlanes().forEach((h) => {
            ...
            for (let l of this.local.updatedProps) {
              ...
              d !== void 0 &&
                ...
                (h.uniforms[l] && Te(d, h.uniforms[l], l),
    ...
    render() {
      ...
      let l =
          ((p = this.local.stateEffectProps) == null
            ? void 0
            : p.borderRadius) ?? this.borderRadius,
        d =
        ...
        u =
          ((v = this.local.stateEffectProps) == null
            ? void 0
            : v.gradientAngle) ?? this.gradientAngle,
        c = i - o.x * a,
        f = r - o.y * h;
      if (
    ...
    render() {
      ...
      const k = (P, w, R, x, z, $, ie) => {
          let B = w
              ...
              .reduce(
                (I, K, ss) =>
                  I + P.measureText(K).width + (ss < w.length - 1 ? z : 0),
                0
              ),
            W;
          if (
            ($ === "center" ? (W = R + (ie - B) / 2 - ie / 2) : (W = R),
            $ === "right")
          )
            for (let I = w.length - 1; I >= 0; I--) {
              const K = w[I];
              ((W -= P.measureText(K).width),
                P.fillText(K, W, x),
                I > 0 && (W -= z));
            }
          else
            for (let I = 0; I < w.length; I++)
              (P.fillText(w[I], W, x), (W += P.measureText(w[I]).width + z));
        },
        C = (P, w) => {
          let R = u + p * w + p / 2 + f / 3;
          this.isSafari
            ? k(t, P, d, R, m, this.textAlign, r)
            : t.fillText(P, d, R);
        },
        y = this.textContent
...
`
            ...
            if (w !== "")
              ((y[P] = w.trim()),
                x !== R.length - 1
                  ? (y.splice(P + 1, 0, R.slice(x).join("")), O++)
                  : z !==
                      `
` && y.push(z));
            else {
              ...
              for (; B.length > 0; ) {
                ...
                for (
                  let K = 0;
                  K < B.length &&
                  (t.measureText(I + B[K]).width <= r || K == 0);
                  K++
                )
                  I += B[K];
                ((B = B.slice(I.length)),
  ...
  function Yt() {
    _.scenes.forEach((n) => {
      ...
      if (
        ...
        t.find((h) => h.uniforms.mousePos) &&
        !(
          (we() &&
            (i = (s = n.interactivity) == null ? void 0 : s.mouse) != null &&
            i.disableMobile) ||
          ((a = (r = n.interactivity) == null ? void 0 : r.mouse) != null &&
            a.disabled)
        )
      ) {
        ...
        n.mouse.page.x > o &&
        n.mouse.page.y > h &&
        n.mouse.page.x < n.lastBbox.width + o &&
        n.mouse.page.y < n.lastBbox.height + h
  ...
  class $t {
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (
        ...
        r
          ...
          : ze(i, this.canvasWidth, this.canvasHeight),
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      if (!e.local.lastMousePos)
        return (
          (e.local.lastMousePos = { x: i / t, y: 1 - r / s }),
    ...
    setEffectPlaneUniforms(e, t) {
      var r, a, h;
      let s =
        ((r = t.local.stateEffectProps) == null ? void 0 : r.speed * 0.4) ??
        t.speed *0.4 ??
        1;
      if (
        (t.animating &&
  ...
  function Qt() {
    (te(window, "scroll", Qe),
      we() ? te(window, "touchmove", Re) : te(window, "mousemove", Re),
      te(window, "routeChange", Xe),
      te(document, "mouseleave", Ze),
      (he = zt(Xt, 16)),
      we() ? te(window, "orientationchange", he) : te(window, "resize", he),
      te(document, de, $e),
      (Ce = !0));
  }
  function De() {
            ...
            (s, i) => {
              ...
              (s.setAttribute("data-us-initialized", !0),
                Je({
                  ...
                  interactivity:
                    p || m
                      ? { mouse: { disableMobile: p, disabled: m } }
                      : null,
                }).then((T) => {
...
// const t=document.createElement("a");t.href="https://unicorn.studio?utm_source=public-url",t.style="position: absolute; display: flex; bottom: 30px; left: 0; width: 190px; margin: 0 auto; right: 0rem; padding: 10px; border-radius: 6px; background-color: rgba(255, 255, 255, 1); box-shadow: 0 3px 9px 0 rgba(0, 0, 0, .2); z-index: 99999999; box-sizing: border-box;",t.target="_blank";const s=document.createElement("img");s.src=fe("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn"),s.alt=fe("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv"),s.style="width: 170px; height: auto;",t.appendChild(s),e.appendChild(t)
